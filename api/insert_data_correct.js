...
mongoose.connect(process.env.MONGO_URI).then(async () => {
    await Feedback.insertMany([
        ...
        { orderId: 'ORD-2024-004', customerName: 'Anita Desai', rating: 4, comment: 'Everything was good but could be a bit warmer.', tags: ['Quality', 'Timeliness'] }
    ]);
    console.log('Inserted correctly to ' + process.env.MONGO_URI);
    process.exit(0);
}).catch(console.error);
